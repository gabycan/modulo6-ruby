...
# ejercicio 1
#Recorrer cada uno de los elementos del arreglo y dividirlos entre la cantidad de dígitos del número.
# each
numeros.each do |n|
...
# ejercicio 2
#Recorrer los elementos del arreglo y regresar un nuevo arreglo que cuente la cantidad de dígitos encontrado por cada número.
resultado = numeros.map do |n|
    # puts "#{n.to_s.length}"
    n.to_s.length.to_s
end
...
# ejercicio 3
#Recorrer los elementos del arreglo y regresar un nuevo arreglo solo con las palabras "par"/"impar" dependiente si el número evaluado era 
#par o impar.
resultado = numeros.map { |n| # [["impar"],["impar"], ["impar"], ["impar"]]
    if n.even?
        "par"
    else
        "impar"
...
# ejercicio 4
#Realizar una búsqueda de todos los múltiplos de 3, al final obtener un arreglo nuevo solo con los números resultantes.
multiplos = []
numeros.map do |n| 
    if n%3==0
        multiplos.push n
...
#ejercicio 5
#Obtener un arreglo resultante de la búsqueda de todos los números que comiencen o terminen por 7.
ensiete = []
